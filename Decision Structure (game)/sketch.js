...
//------------------Level 2------------------//
    ...
    //First enemy, can move around and bounces off the walls
    fill(0);
    y1+=ySpeed1;
    x1+=xSpeed1;
    rect(x1,y1,100,100);
...
//------------------Level 4/You win------------------//
  ...
  //Incase of Collision with the ractangles, shows a Screen indicating that the player failed and option to reset to level 2
